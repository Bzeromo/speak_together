...
class AppMainTheme extends StatelessWidget {
  const AppMainTheme({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final player = AudioPlayer();
    SystemChrome.setPreferredOrientations([DeviceOrientation.landscapeLeft, DeviceOrientation.landscapeRight]);
    player.play(AssetSource('sounds/main_theme.mp3'));
        ...
        child: ListView(
            ...
            children:[
              Column(
                children: [
                  ...
                  Container(
                      ...
                      child: const Text('토끼와 빠르게!', style: TextStyle(color: Color(
                          0xff000000), fontSize: 30, fontWeight: FontWeight.w700),)),
                  Container(
                    height: 185,
                    width: 200,
                    child: Image.asset('assets/images/2_뛰다 1.png'),
              ...
              Column(
                children: [
                  Container(
              margin: EdgeInsets.only(top: 168, bottom:5),
            child: const Text('천천히 읽고 싶으면\n        나를 눌러!', style: TextStyle(color: Color(
                0x6B000000), fontSize: 15, fontWeight: FontWeight.w700),)
                  ),
                  Container(
                      child: IconButton(onPressed: (){
                        player.stop();
                        Navigator.push(
                            context, MaterialPageRoute(builder: (context) => AppMainThemeSlow()));},
                        icon: Image.asset('assets/images/기쁘다_거북이.png'),
                        iconSize: 120,
                      ),
                ...
                children: [
                  ...
                  Container(
                    child: IconButton(onPressed: (){
                      player.stop();
                      Navigator.push(
                          context, MaterialPageRoute(builder: (context) => RabbitRabbitTurtle1()));},
                ...
                children: [
                  ...
                  Container(
                    child: IconButton(onPressed: (){
                      player.stop();
                      Navigator.push(
                          context, MaterialPageRoute(builder: (context) => RabbitBabyPig1()));},
                ...
                children: [
                  ...
                  Container(
                    child: IconButton(onPressed: (){
                      player.stop();
                      Navigator.push(
                          context, MaterialPageRoute(builder: (context) => RabbitHeungbu1()));},
