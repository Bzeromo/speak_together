...
import 'package:speak_together/tutorial5.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading:  IconButton(
            onPressed: () {
                  Navigator.push(
                  context, MaterialPageRoute(builder: (context) => Tutorial5()));},
            color: Colors.purple,
      ...
      floatingActionButton: Column(
        children: [
          Container(
            ...
            margin: EdgeInsets.only(top:130, right: 80),
          ),
          Container(
          ...
          Container(
            child: IconButton(onPressed: (){
              Navigator.push(
                  context, MaterialPageRoute(builder: (context) => SpeechPic("나비", "butterfly_test")));},
